                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">John Doe <span>#0001</span></a>
                                        </h2>
                                    </td>
                                    <td>20 Dec 2020</td>
                                    <td>Design</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Richard Miles <span>#0002</span></a>
                                        </h2>
                                    </td>
                                    <td>21 Dec 2020</td>
                                    <td>Web Developer</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">John Smith <span>#003</span></a>
                                        </h2>
                                    </td>
                                    <td>22 Dec 2020</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Mike Litorus <span>#004</span></a>
                                        </h2>
                                    </td>
                                    <td>23 Dec 2020</td>
                                    <td>IOS Developer</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Wilmer Deluna <span>#005</span></a>
                                        </h2>
                                    </td>
                                    <td>24 Dec 2020</td>
                                    <td>Team Leader</td>
