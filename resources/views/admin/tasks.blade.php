...
@section('content')
    ...
    @include ('admin/layouts/task_sidebar')
                        ...
                        <div>
                            <ul class="chat-user-list">
                                <li>
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}"></span>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}"></span>
                                            <div class="media-body align-self-center text-nowrap">
                        ...
                        <div>
                            <ul class="chat-user-list">
                                <li>
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-16.jpg')}}"></span>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-08.jpg')}}"></span>
                                            <div class="media-body media-middle text-nowrap">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-26.jpg')}}"></span>
                                            <div class="media-body media-middle text-nowrap">
