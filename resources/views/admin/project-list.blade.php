                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <ul class="team-members text-nowrap">
                                            ...
                                            <li>
                                                <a href="#" title="John Smith" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" title="Mike Litorus" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-05.jpg')}}"></a>
                                            </li>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{route('admin.project-view')}}">Project Management</a>
                                    </td>
                                    <td>PRO-0002</td>
                                    <td>
                                        <ul class="team-members">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{route('admin.project-view')}}">Video Calling App</a>
                                    </td>
                                    <td>PRO-0003</td>
                                    <td>
                                        <ul class="team-members">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="project-members">
                                            ...
                                            <a href="#" data-bs-toggle="tooltip" title="John Smith" class="avatar">
                                                <img src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}" alt="">
                                            </a>
