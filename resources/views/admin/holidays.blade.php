        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="view-toggle">
                    ...
                    <button onclick="toggleView('calendar')" class="btn calendar-btn calendar-view"><i class="fa fa-calendar"
                                                ...
                                                <td>
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#edit_employee{{$data->id}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                    ...
                    @foreach ($holidays as $holiday)
                        {
                            ...
                            start: (function() {
                                ...
                                return new Date(year, month, day); // Construct new date with current year
                            })(),
