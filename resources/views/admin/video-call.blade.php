                                ...
                                <div class="chat-contents">
                                    <div class="chat-content-wrap">
                                        <div class="user-video">
                                            <img src="{{asset('public/assets/img/video-call.jpg')}}" alt="">
                                        </div>
                                        <div class="my-video">
                                            <ul>
                                                <li>
                                                    <img src="{{asset('public/assets/img/profiles/avatar-01.jpg')}}" class="img-fluid" alt="">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="chat-box">
                                                <div class="chats">
                                                    ...
                                                    <div class="chat chat-left">
                                                        <div class="chat-avatar">
                                                            <a href="{{route('admin.admin-profile')}}" class="avatar">
                                                                <img alt="" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}" class="img-fluid rounded-circle">
                                                            </a>
                                                        </div>
                                                        <div class="chat-body">
                                                            <div class="chat-bubble">
                                                    ...
                                                    <div class="table-content">
                                                        <div class="chat-profile-img">
                                                            <div class="edit-profile-img">
                                                                <img src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}" alt="">
