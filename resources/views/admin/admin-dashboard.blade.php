                                ...
                                <div class="card-body">
                                    ...
                                    <div class="leave-info-box">
                                        <div class="media d-flex align-items-center">
                                            <a href="{{route('admin.admin-profile')}}" class="avatar"><img alt="" src="{{asset('public/assets/img/user.jpg')}}"></a>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="client-{{route('admin.admin-profile')}}">Barry Cuda <span>CEO</span></a>
                                                        </h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="#" class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-19.jpg')}}"></a>
                                                            <a href="client-{{route('admin.admin-profile')}}">Tressa Wexler <span>Manager</span></a>
                                                        </h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="client-{{route('admin.admin-profile')}}">Ruby Bartlett <span>CEO</span></a>
                                                        </h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="client-{{route('admin.admin-profile')}}"> Misty Tison <span>CEO</span></a>
                                                        </h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="client-{{route('admin.admin-profile')}}"> Daniel Deacon <span>CEO</span></a>
                                                        </h2>
                                                    </td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table custom-table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h2><a href="{{route('admin.project-view')}}">Office Management</a></h2>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2><a href="{{route('admin.project-view')}}">Project Management</a></h2>
                                                        <small class="block text-ellipsis">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2><a href="{{route('admin.project-view')}}">Video Calling App</a></h2>
                                                        <small class="block text-ellipsis">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2><a href="{{route('admin.project-view')}}">Hospital Administration</a></h2>
                                                        <small class="block text-ellipsis">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2><a href="{{route('admin.project-view')}}">Digital Marketplace</a></h2>
                                                        <small class="block text-ellipsis">
