                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="section">
                                            ...
                                            <div class="row user-tabs">
                                                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                                    <ul class="nav nav-tabs nav-tabs-bottom">
                                                        <li class="nav-item">
                                                            <a href="#event001" data-bs-toggle="tab"
                                                                class="nav-link active">No Status</a>
                                                        </li>
                                                        @foreach ($eventStatus as $index => $statusData)
                                                            <li class="nav-item">
                                                                <a href="#event{{ $statusData->id }}" data-bs-toggle="tab"
                                                                    class="nav-link ">{{ $statusData->status_type }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="tab-content">
                                                                ...
                                                                <tbody id="events-table-body">
                                                                    ...
                                                                    @foreach ($filteredData as $data)
                                                                        <tr data-month="{{ date('n', strtotime($data->event_date ?? $data->created_at)) - 1 }}"
                                                                            ...
                                                                            <td>{{ $data->event_name ?? $data->company_name }}
                                                                            </td>
                                                                            <td>{{ $data->event_date ?? $data->created_at }}
                                                                            </td>
                                                                            <td>{{ $data->website }}</td>
                                                                            <td>{{ $data->email_id }}</td>
                                                                            <td>{{ $data->phone_no ?? $data->phone }}
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <div
                                                                                    class="dropdown action-label dropdown-item">
                                            ...
                                            @foreach ($eventStatus as $index => $statusData)
                                                <div id="event{{ $statusData->id }}"
                                                    class="pro-overview tab-pane fade show">
                                                    <div class="row">
                                                        {{-- <div class="col-md-12 text-right mb-2">
                                                                {{$statusData->status_type}}
                                                            </div> --}}
                                                            ...
                                                            <div class="table-responsive">
                                                                <table
                                                                    ...
                                                                    <tbody id="events-table-body">
                                                                        @php
                                                                            $filteredData = $combinedData->filter(
                                                                                fn($data) => $data->status  == $statusData->id,
                                                                            );
                                                                        @endphp
                                                                        @foreach ($filteredData as $data)
                                                                            <tr data-month="{{ date('n', strtotime($data->event_date ?? $data->created_at)) - 1 }}"
