    ...
    <div class="sidebar sidebar-twocol">
        ...
        <div class="sidebar-right">
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade " id="v-pills-dashboard" role="tabpanel" aria-labeledby="v-pills-dashboard-tab">
                    <p>Dashboard</p>
                    <ul>
                        <li>
                ...
                <div class="tab-pane fade" id="v-pills-apps" role="tabpanel" aria-labelledby="v-pills-apps-tab">
                    ...
                    <ul>
                        <li>
                            <a class="" href="chat.php">Chat</a>
                        </li>
                        <li class="sub-menu">
                            <a href="#">Calls <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a class="" href="voice-call.php">Voice Call</a></li>
                                <li><a class="" href="video-call.php">Video Call</a></li>
                                <li><a class="" href="outgoing-call.php">Outgoing Call</a></li>
                                <li><a class="" href="incoming-call.php">Incoming Call</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="" href="events.php">Calendar</a>
                        </li>
                        <li>
                            <a class="" href="contacts.php">Contacts</a>
                        </li>
                        <li>
                            <a class="" href="inbox.php">Email</a>
                        </li>
                        <li>
                            <a class="" href="file-manager.php">File Manager</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-employees" role="tabpanel" aria-labelledby="v-pills-employees-tab">
                    <p>Employees</p>
                    <ul>
                        <li><a class="" href="employees.php">All Employees</a></li>
                        <li><a class="" href="holidays.php">Holidays</a></li>
                        <li><a class="" href="leaves.php">Leaves (Admin) <span class="badge rounded-pill bg-primary float-end">1</span></a></li>
                        <li><a class="" href="leaves-employee.php">Leaves (Employee)</a></li>
                        <li><a class="" href="leave-{{route('admin.settings')}}">Leave Settings</a></li>
                        <li><a class="" href="attendance.php">Attendance (Admin)</a></li>
                        <li><a class="" href="attendance-employee.php">Attendance (Employee)</a></li>
                        <li><a class="" href="departments.php">Departments</a></li>
                        <li><a class="" href="designations.php">Designations</a></li>
                        <li><a class="" href="timesheet.php">Timesheet</a></li>
                        <li><a class="" href="shift-scheduling.php">Shift & Schedule</a></li>
                        <li><a class="" href="overtime.php">Overtime</a></li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade " id="v-pills-projects" role="tabpanel" aria-labelledby="v-pills-projects-tab">
                    ...
                    <ul>
                        ...
                        <li><a class="" href="tasks.php">Tasks</a></li>
                        <li><a class="" href="task-board.php">Task Board</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-leads" role="tabpanel" aria-labelledby="v-pills-leads-tab">
                    <p>Leads</p>
                    <ul>
                        <li><a class="" href="leads.php">Leads</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-tickets" role="tabpanel" aria-labelledby="v-pills-tickets-tab">
                    <p>Tickets</p>
                    <ul>
                        <li><a class="" href="tickets.php">Tickets</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-sales" role="tabpanel" aria-labelledby="v-pills-sales-tab">
                    <p>Sales</p>
                    <ul>
                        <li><a class="" href="estimates.php">Estimates</a></li>
                        <li><a class="" href="invoices.php">Invoices</a></li>
                        <li><a class="" href="payments.php">Payments</a></li>
                        <li><a class="" href="expenses.php">Expenses</a></li>
                        <li><a class="" href="provident-fund.php">Provident Fund</a></li>
                        <li><a class="" href="taxes.php">Taxes</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-accounting" role="tabpanel" aria-labelledby="v-pills-accounting-tab">
                    ...
                    <ul>
                        ...
                        <li><a class="" href="budgets.php">Budgets</a></li>
                        <li><a class="" href="budget-expenses.php">Budget Expenses</a></li>
                        <li><a class="" href="budget-revenues.php">Budget Revenues</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-payroll" role="tabpanel" aria-labelledby="v-pills-payroll-tab">
                    <p>Payroll</p>
                    <ul>
                        <li><a class="" href="salary.php"> Employee Salary </a></li>
                        <li><a class="" href="salary-view.php"> Payslip </a></li>
                        <li><a class="" href="payroll-items.php"> Payroll Items </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-policies" role="tabpanel" aria-labelledby="v-pills-policies-tab">
                    <p>Policies</p>
                    <ul>
                        <li><a class="" href="policies.php"> Policies </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
                    <p>Reports</p>
                    <ul>
                        <li><a class="" href="expense-reports.php"> Expense Report </a></li>
                        <li><a class="" href="invoice-reports.php"> Invoice Report </a></li>
                        <li><a class="" href="payments-reports.php"> Payments Report </a></li>
                        <li><a class="" href="project-reports.php"> Project Report </a></li>
                        <li><a class="" href="task-reports.php"> Task Report </a></li>
                        <li><a class="" href="user-reports.php"> User Report </a></li>
                        <li><a class="" href="employee-reports.php"> Employee Report </a></li>
                        <li><a class="" href="payslip-reports.php"> Payslip Report </a></li>
                        <li><a class="" href="attendance-reports.php"> Attendance Report </a></li>
                        <li><a class="" href="leave-reports.php"> Leave Report </a></li>
                        <li><a class="" href="daily-reports.php"> Daily Report </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-performance" role="tabpanel" aria-labelledby="v-pills-performance-tab">
                    <p>Performance</p>
                    <ul>
                        <li><a class="" href="performance-indicator.php"> Performance Indicator </a></li>
                        <li><a class="" href="performance.php"> Performance Review </a></li>
                        <li><a class="" href="performance-appraisal.php"> Performance Appraisal </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-goals" role="tabpanel" aria-labelledby="v-pills-goals-tab">
                    <p>Goals</p>
                    <ul>
                        <li><a class="" href="goal-tracking.php"> Goal List </a></li>
                        <li><a class="" href="goal-type.php"> Goal Type </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-training" role="tabpanel" aria-labelledby="v-pills-training-tab">
                    <p>Training</p>
                    <ul>
                        <li><a class="" href="training.php"> Training List </a></li>
                        <li><a class="" href="trainers.php"> Trainers</a></li>
                        <li><a class="" href="training-type.php"> Training Type </a></li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade " id="v-pills-resignation" role="tabpanel" aria-labelledby="v-pills-resignation-tab">
                    <p>Resignation</p>
                    <ul>
                        <li><a class="" href="resignation.php"> Resignation </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-termination" role="tabpanel" aria-labelledby="v-pills-termination-tab">
                    <p>Termination</p>
                    <ul>
                        <li><a class="" href="termination.php"> Termination </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-assets" role="tabpanel" aria-labelledby="v-pills-assets-tab">
                    <p>Assets</p>
                    <ul>
                        <li><a class="" href="assets.php"> Assets </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-jobs" role="tabpanel" aria-labelledby="v-pills-jobs-tab">
                    <p>Jobs</p>
                    <ul>
                        <li><a class="" href="user-dashboard.php"> User Dasboard </a></li>
                        <li><a class="" href="jobs-dashboard.php"> Jobs Dasboard </a></li>
                        <li><a class="" href="jobs.php"> Manage Jobs </a></li>
                        <li><a class="" href="manage-resumes.php"> Manage Resumes </a></li>
                        <li><a class="" href="shortlist-candidates.php"> Shortlist Candidates </a></li>
                        <li><a class="" href="interview-questions.php"> Interview Questions </a></li>
                        <li><a class="" href="offer_approvals.php"> Offer Approvals </a></li>
                        <li><a class="" href="experiance-level.php"> Experience Level </a></li>
                        <li><a class="" href="candidates.php"> Candidates List </a></li>
                        <li><a class="" href="schedule-timing.php"> Schedule timing </a></li>
                        <li><a class="" href="apptitude-result.php"> Aptitude Results </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-knowledgebase" role="tabpanel" aria-labelledby="v-pills-knowledgebase-tab">
                    <p>Knowledgebase</p>
                    <ul>
                        <li><a class="" href="knowledgebase.php"> Knowledgebase </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-activities" role="tabpanel" aria-labelledby="v-pills-activities-tab">
                    <p>Activities</p>
                    <ul>
                        <li><a class="" href="activities.php" class="active"> Activities </a></li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    <p>Settings</p>
                    <ul>
                        <li><a class="" href="{{route('admin.settings')}}"> Settings </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade " id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <p>Profile</p>
                    <ul>
                        <li><a class="" href="{{route('admin.admin-profile')}}"> Employee Profile </a></li>
                        <li><a class="" href="client-{{route('admin.admin-profile')}}"> Client Profile </a></li>
                    </ul>
                </div>
                ...
                <div class="tab-pane fade" id="v-pills-subscriptions" role="tabpanel" aria-labelledby="v-pills-subscriptions-tab">
                    <p>Subscriptions</p>
                    <ul>
                        <li><a class="" href="subscriptions.php"> Subscriptions (Admin) </a></li>
                        <li><a class="" href="subscriptions-company.php"> Subscriptions (Company) </a></li>
                        <li><a class="" href="subscribed-companies.php"> Subscribed Companies</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-pages" role="tabpanel" aria-labelledby="v-pills-pages-tab">
                    ...
                    <ul>
                        ...
                        <li><a class="" href="terms.php"> Terms </a></li>
                        <li><a class="" href="privacy-policy.php"> Privacy Policy </a></li>
                        <li><a class="" href="blank-page.php"> Blank Page </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-forms" role="tabpanel" aria-labelledby="v-pills-forms-tab">
                    ...
                    <ul>
                        ...
                        <li><a class="" href="form-mask.php"> Form Mask </a></li>
