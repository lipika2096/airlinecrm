...
<div class="header">
    ...
    <div class="header-left">
         <a href="admin-dashboard.php" class="logo">
            <img src="{{asset('public/assets/img/logo.png')}}" width="40" height="40" alt="">
        </a>
                    ...
                    <ul class="notification-list">
                        ...
                        <li class="notification-message">
                            <a href="activities.php">
                                <div class="media d-flex">
                                    <span class="avatar flex-shrink-0">
                                        <img alt="" src="{{asset('public/assets/img/profiles/avatar-03.jpg')}}">
                                    </span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="activities.php">
                                <div class="media d-flex">
                                    <span class="avatar flex-shrink-0">
                                        <img alt="" src="{{asset('public/assets/img/profiles/avatar-06.jpg')}}">
                                    </span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="activities.php">
                                <div class="media d-flex">
                                    <span class="avatar flex-shrink-0">
                                        <img alt="" src="{{asset('public/assets/img/profiles/avatar-17.jpg')}}">
                                    </span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="chat.php">
                                <div class="list-item">
                                    <div class="list-left">
                                        <span class="avatar">
                                            <img alt="" src="{{asset('public/assets/img/profiles/avatar-08.jpg')}}">
                                        </span>
                                    </div>
                                    <div class="list-body">
