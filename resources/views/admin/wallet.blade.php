            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-end ms-auto">
                        <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_Wallet"><i
                                class="fa fa-plus"></i> Add Wallet</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                        ...
                                        <tbody>
                                            @foreach ($agents as $agent)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action-icons">                                                                <a href="#" class="action-icon"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#view_Wallet{{ $agent->id }}"><i
                                                                        class="fa fa-eye m-r-5"></i> </a>
                                                                <form
                                                                    action="{{ route('admin.wallet.destroy', $agent->id) }}"
                                                                    method="POST" style="display:inline;">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit" class="action-icon" style="border:none;background:none;color:inherit;"><i
                                                ...
                                                <!-- View Wallet Modal -->
                                                <div id="view_Wallet{{ $agent->id }}" class="modal custom-modal fade"
                                                    role="dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row" style="display:flex">
                                                                    <p><strong>Agent Name:</strong> {{ $agent->first_name }}
                                                                        {{ $agent->last_name }}</p>
                                                                    <p><strong>Total Wallet:</strong>
                                                                        {{ $agent->total_wallet }}</p>
                                                                    ...
                                                                    @foreach ($agent->wallets as $wallet)
                                                                        <li class="col-md-4 card">
                                                                            ...
                                                                            <p><strong>Available Balance:</strong>
                                                                                {{ $wallet->available_balance }}</p>
                                                                            <p><strong>Razorpay ID:</strong>
                                                                                {{ $wallet->razorpay_id }}</p>
                                                                            ...
                                                                            <p><strong>Date:</strong> {{ $wallet->date }}
                                                                            </p>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
        ...
        <div id="add_Wallet" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.wallet.store') }}" class="forms-sample" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="agent_id" class="form-control" required>
                                            ...
                                            @foreach ($eligibleAgents as $eligibleAgent)
                                                <option value="{{ $eligibleAgent->id }}">{{ $eligibleAgent->first_name }}
                                                    {{ $eligibleAgent->last_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="wallet" class="form-control"
                                            placeholder="Wallet" value="{{ old('wallet') }}">
