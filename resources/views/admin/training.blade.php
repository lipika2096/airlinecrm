                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">John Doe </a>
                                        </h2>
                                    </td>
                                    <td>
                                        <ul class="team-members">
                                            <li>
                                                <a href="#" title="Bernardo Galaviz" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" title="Richard Miles" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}"></a>
                                            </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Richard Miles</a>
                                        </h2>
                                    </td>
                                    <td>
                                        <ul class="team-members">
                                            <li>
                                                <a href="#" title="John Doe" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" title="Richard Miles" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}"></a>
                                            </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Mike Litorus </a>
                                        </h2>
                                    </td>
                                    <td>
                                        <ul class="team-members">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{route('admin.admin-profile')}}">Wilmer Deluna </a>
                                        </h2>
                                    </td>
                                    <td>
                                        <ul class="team-members">
