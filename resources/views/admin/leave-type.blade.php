                                ...
                                <td>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input status-toggle" type="checkbox"
                                            data-id="{{ $leave->id }}" {{ $leave->status ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown-action">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#edit_leavetype{{$leave->id}}"><i
                                                class="fa fa-pencil m-r-5"></i></a>
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#delete_leavetype{{$leave->id}}"><i
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('admin.leave-type.update',$leave->id)}}"
                                                method="post">
                                                @csrf
                                                @method('PUT')
                ...
                <div class="modal-body">
                    <form action="{{route('admin.leave-type.store')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label for="colorPicker">Choose a color:</label>
                            <input type="color" id="colorPicker" class="form-control" name="color" value="#FF0000">
