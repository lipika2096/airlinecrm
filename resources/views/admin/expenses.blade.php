                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{route('admin.admin-profile')}}" class="avatar avatar-xs"><img src="{{asset('public/assets/img/profiles/avatar-04.jpg')}}" alt=""></a>
                                                    <a href="{{route('admin.admin-profile')}}">Loren Gatlin</a>
                                                </h2>
                                            </td>
                                            <td>$1215</td>
                                            <td>Cash</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{route('admin.admin-profile')}}" class="avatar avatar-xs"><img src="{{asset('public/assets/img/profiles/avatar-03.jpg')}}" alt=""></a>
                                                    <a href="{{route('admin.admin-profile')}}">Tarah Shropshire</a>
                                                </h2>
                                            </td>
                                            <td>$1215</td>
                                            <td>Cheque</td>
