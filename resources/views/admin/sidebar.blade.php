...
@endif
            ...
            <li>
                ...
                @if (auth('admin')->user()->hasRole('admin'))
                    ...
                    <li class="submenu">
                        <a href="#" class="noti-dot"><i class="la la-user"></i> <span> Group Request</span> <span
                                class="menu-arrow"></span></a>
                                <ul style="display: none;">
                                    <li><a class="" href="{{ route('admin.requests') }}"> Open Request </a></li>
                                    <li><a class="" href="{{ route('admin.confirm.requests') }}"> Confirm Request </a></li>
                                </ul>
                    </li>
                @endif
                @if (auth('admin')->user()->hasRole('admin'))
