            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p class="d-inline text-dark font-weight-bolder">Welcome to <b class="d-inline text-capitalize">{{
                            $airlineDetails->airline->airline_name }}</b> airlines</p>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex;">
                                            <a class="btn" data-bs-toggle="modal"
                                                data-bs-target="#edit_sla{{ $sla->id }}"><i class="fa fa-edit"></i></a>
                                            <a class="btn" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title text-dark"
                                                        style="font-size: 22px !important;">Edit SLA</h5>
                                                    <button type="button" class="close" data-bs-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('admin.airline.sla.update', $sla->id) }}#sla"
                                                        ...
                                                        <div class="form-group">
                                                            <label>
                                                                <input type="checkbox" id="toggleUpload_{{ $sla->id }}">
                                                                Upload
                                                                Documents
                                                            </label>
                                                        </div>
                                                        <div class="form-group" id="uploadSection_{{ $sla->id }}"
                                                            style="display: none;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="content"
                                                                id="editor{{ $sla->id }}">{{ $sla->content }}</textarea>
                                                        </div>
                                                        <button type="submit" class="btn btn-primary">Update</button>
                                                    </form>
                                                    <script src="https://cdn.ckeditor.com/4.17.1/full/ckeditor.js">
                                                    </script>
                                                    <script>
                                ...
                                <table class="table table-striped datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" disabled {{ $headOffice->add_to_mail_list == 1 ?
                                                'checked' : '' }}>
                                            </td>
                                        ...
                                        <div id="delete_headoffice{{$headOffice->id}}" class="modal custom-modal fade"
                                            role="dialog">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            ...
                                                            @method('DELETE')
                                                            <p>Are you sure you want to Deactive
                                                                <strong>{{$headOffice->first_name}}
                                                                    {{$headOffice->last_name}}'s</strong>contact detail?
                                                            </p>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                        ...
                                        <!-- /Delete head office Modal -->
                                        <div id="edit_headoffice{{ $headOffice->id }}" class="modal custom-modal fade"
                                            role="dialog">
                                                        ...
                                                        <form
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control"
                                                                            value="{{ $headOffice->title }}" type="text"
                                                                            name="title">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <input class="form-control" type="text"
                                                                        name="department"
                                                                        value="{{ $headOffice->department }}" required>
                                                                </div>
                                                                <div class="col-sm-6 form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group ">
                                                                        <label class="col-form-label "
                                                                            style="margin-bottom:-5px;">Add to mail List
                                                                            <span class="text-danger">*</span></label>
                                                                        <input type="hidden" name="add_to_mail_list"
                                                                            value="0">
                                                                        <input type="checkbox" name="add_to_mail_list"
                                                                            value="1" {{ $headOffice->add_to_mail_list
                                                                        == 1 ? 'checked' : '' }}>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped  datatable">
                                ...
                                <tbody>
                                    ...
                                    <!-- /Delete fleet Modal -->
                                    <div id="edit_fleet{{ $fleet->id }}" class="modal custom-modal fade" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <form
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 form-group">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    name="aircraft_reg"
                                                                    value="{{ $fleet->aircraft_reg ?? '' }}" required>
                                                            </div>
                                                            ...
                                                            {{-- <label class="col-form-label">Number of
                                                                Aircraft <span class="text-danger">*</span></label> --}}
                                                            <input class="form-control" type="hidden"
                                                            ...
                                                            <div class="col-sm-6 form-group">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    name="fleet_type"
                                                                    value="{{ $fleet->fleet_type ?? '' }}" required>
                                                            </div>
                                                            <div class="col-sm-6 form-group">
                                    ...
                                    <form action="{{ route('admin.airline.fleet.store') }}#fleet" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <input class="form-control" type="hidden" name="airline_id"
                                                    value="{{ $airlineDetails->airline_id }}">
                                                <input class="form-control" type="hidden" name="fleet_id" value="">
                                                <div class="form-group">
                                                    <label class="col-form-label">Aircraft reg. <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" type="text" name="aircraft_reg" value=""
                                                        required>
                                                </div>
                                            </div>
                                            {{-- <div class="col-sm-6">
                                                <div class="form-group"> --}}
                                                    {{-- <label class="col-form-label">Name <span
                                                            class="text-danger">*</span></label> --}}
                                                    <input class="form-control" type="hidden" name="name" value="null"
                                                        required>
                                                    {{-- <label class="col-form-label">IATA <span
                                                            class="text-danger">*</span></label> --}}
                                                    <input class="form-control" type="hidden" name="iata" value="null"
                                                        required>
                                                    {{-- <label class="col-form-label">ICAO <span
                                                            class="text-danger">*</span></label> --}}
                                                    <input class="form-control" type="hidden" name="icao" value="null"
                                                        required>

                                                    {{-- <label class="col-form-label">Number of Aircraft <span
                                                            class="text-danger">*</span></label> --}}
                                                    <input class="form-control" type="hidden" name="number_of_aircraft"
                                                        value="1" required>
                                                    {{--
                                                </div>
                                            </div> --}}
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label">Fleet Type <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" type="text" name="fleet_type" value=""
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <div id="delete_aircraft{{$data->id}}" class="modal custom-modal fade"
                                            role="dialog">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header mb-1">
                                        ...
                                        <!-- /Delete fleet Modal -->
                                        <div id="edit_aircraft{{ $data->id }}" class="modal custom-modal fade"
                                            role="dialog">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="col-form-label">Flight Number
                                                                            <span class="text-danger">*</span></label>
                                                                        <input class="form-control"
                                                                            value="{{ $data->flight_no }}" type="text"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="date"
                                                                            name="valid_till"
                                                                            value="{{ $data->valid_till }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-form-label">Arrival Time
                                                                            <span class="text-danger">*</span></label>
                                                                        <input class="form-control"
                                                                            type="datetime-local" name="arrival_time"
                                                                            value="{{ $data->arrival_time }}" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="text"
                                                                            name="aircraft_type"
                                                                            value="{{ $data->aircraft_type }}" required>
                                                                    </div>
                                                                    <div class="form-group">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="col-form-label">Origin Station <span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="text" name="origin_station" required>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="col-form-label">Arrival Station <span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="text" name="arrival_station" required>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="col-form-label">Aircraft Type <span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="text" name="aircraft_type" required>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="col-form-label">Frequency <span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="text" name="frequency" required>
                                            </div>
                                            <div class="col-sm-6">
                                                {{-- <label for="created_by">Created By</label> --}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped datatable">
                                ...
                                <tbody>
                                    ...
                                    <!-- /Delete fleet Modal -->
                                    <div id="edit_library{{ $data->id }}" class="modal custom-modal fade" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
            ...
            <div id="rules" class="pro-overview tab-pane fade show">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped datatable Rules">
                                <thead>
                                    <tr>
                                        <th>Do's</th>
                                        <th>Dont's</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display:flex;">
                                            ...
                                            <form id="toggle-status-form5-{{ $rule->id }}"
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox"
                                                        onchange="updateStatus5({{ $rule->id }}, this)" {{ $rule->status
                                                    == 1 ? 'checked' : '' }}>
                                    ...
                                    <div id="edit_rules{{ $rule->id }}" class="modal fade" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="dos" id="dos"
                                                                class="form-control ckeditor">{{ $rule->dos }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="donts">Dont's</label>
                                                            <textarea name="donts" id="donts"
                                                                class="form-control ckeditor">{{ $rule->donts }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="cancellation_policy"
                                                                ...
                                                                class="form-control ckeditor">{{ $rule->cancellation_policy }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="date_change_policy">Date Change
                                                                Policy</label>
                                                            <textarea name="date_change_policy" id="date_change_policy"
                                                                class="form-control ckeditor">{{ $rule->date_change_policy }}</textarea>
                                                        </div>
            ...
            <div id="provision" class="pro-overview tab-pane fade show">
                <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped datatable">
                                ...
                                <tbody>
                                    ...
                                    <div id="delete_agreements{{$agreement->id}}" class="modal custom-modal fade"
                                        role="dialog">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                    ...
                                    <!-- /Delete agreements Modal -->
                                    <div id="edit_agreements{{ $agreement->id }}" class="modal fade" role="dialog">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="term"
                                                                    name="term" value="{{ $agreement->term }}">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="agreement_status" name="agreement_status"
                                                                    class="form-control">
                                                                    <option value="1" {{ $agreement->agreement_status ==
                                                                        1 ? 'selected' : '' }}>
                                                                        Signed</option>
                                                                    <option value="2" {{ $agreement->specialFare &&
                                                                        $data->agreement_status->status == 2 ?
                                                                        'selected' : '' }}>
                                                                        Expired</option>
                                                                    <option value="3" {{ $agreement->specialFare &&
                                                                        $data->agreement_status->status == 3 ?
                                                                        'selected' : '' }}>
                                                                        Not Renewed</option>
                                                                </select>
                                                            </div>
                    ...
                    <div id="add_pli" class="modal  custom-modal fade" role="dialog">
                        <div class="modal-dialog container padding-custom modal-dialog-centered modal-xl "
                            role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('admin.airline.pli.store') }}#provision" method="POST"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-4 ">
                                                ...
                                                <input type="text" name="incentive_description" class="form-control">
                                            </div>
                                            <!-- </div> -->
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="number" name="businessclass_intl" class="form-control">
                                            </div>

                                            <div class="col-sm-4">
                                                <label for="term">Business Class</label><br>
                                                <label for="term">DOM:</label>
                                                <input type="number" name="businessclass_dom" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class=" row form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <label for="term">INTL:</label>
                                                <input type="number" name="premiumclass_intl" class="form-control">
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="term">Preimum Class</label><br>
                                                <label for="term">DOM:</label>
                                                <input type="number" name="premiumclass_dom" class="form-control">
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="term">Economy Class</label><br>
                                                <label for="term">INTL:</label>
                                                <input type="number" name="economyclass_intl" class="form-control">
                                            </div>
                                            <!-- </div> -->
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="term">Economy Class</label><br>
                                                <label for="term">DOM:</label>
                                                <input type="number" name="economyclass_dom" class="form-control">
                                            </div>
                                            <div class="col-sm-4">
                                                <lable> &nbsp;</lable><br>
                ...
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " style="line-height:38px !important;"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <button type="button" id="searchButton" class="btn add-btn text-right"
                                            style="width:20px !important; padding:5px;">Search</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-md-5">
                        <div class=" ms-auto mt-2  mb-2">
                            <a class="btn add-btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_target"><i
