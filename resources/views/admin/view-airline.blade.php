                                        ...
                                        @foreach ($slas as $index => $sla)
                                            <tr>
                                                ...
                                                <td style="    display: flex;">
                                                    ...
                                                    <form id="toggle-status-form-{{ $sla->id }}"
                                                        action="{{ route('admin.airline.sla.statusupdate', $sla->id) }}#sla"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                                onchange="updateStatus({{ $sla->id }}, this)"
                                                                {{ $sla->status == 1 ? 'checked' : '' }}>
                                        ...
                                        <tbody>
                                            @foreach ($headOffices as $index => $headOffice)
                                                <tr>
                                                    ...
                                                    <td style="display:flex;">
                                                        <a class="btn" data-bs-toggle="modal"
                                                            data-bs-target="#edit_headoffice{{ $headOffice->id }}"><i
                                                                class="fa fa-edit"></i></a>
                                                        <form id="toggle-status-form1-{{ $headOffice->id }}"
                                                            action="{{ route('admin.airline.headOffice.statusupdate', $headOffice->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <label class="switch">
                                                                <input type="checkbox"
                                                                    onchange="updateStatus1({{ $headOffice->id }}, this)"
                                                                    {{ $headOffice->status == 1 ? 'checked' : '' }}>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </form>
                                                    </td>
                                        ...
                                        @foreach ($fleets as $index => $fleet)
                                            <tr>
                                                ...
                                                <td style="display:flex;">
                                                    ...
                                                    <form id="toggle-status-form2-{{ $fleet->id }}"
                                                        action="{{ route('admin.airline.fleet.statusupdate', $fleet->id) }}#fleet"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                                onchange="updateStatus2({{ $fleet->id }}, this)"
                                                                {{ $fleet->status == 1 ? 'checked' : '' }}>
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </form>
                                                </td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-form-label">ICAO <span
                                                                class="text-danger">*</span></label>
                                                        <input class="form-control" type="text" name="icao"
                                                            value="" required>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            @foreach ($aircrafts as $index => $data)
                                                <tr>
                                                    ...
                                                    <td style="display:flex;">
                                                        ...
                                                        <form id="toggle-status-form3-{{ $data->id }}"
                                                            action="{{ route('admin.airline.schedule.statusupdate', $data->id) }}#schedule"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <label class="switch">
                                                                <input type="checkbox"
                                                                    onchange="updateStatus3({{ $data->id }}, this)"
                                        ...
                                        @foreach ($library as $index => $data)
                                            <tr>
                                                ...
                                                <td style="display:flex;">
                                                    ...
                                                    <form id="toggle-status-form4-{{ $data->id }}"
                                                        action="{{ route('admin.airline.library.statusupdate', $data->id) }}#library"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                                onchange="updateStatus4({{ $data->id }}, this)"
                                                                {{ $data->status == 1 ? 'checked' : '' }}>
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="display:flex">
                                                        ...
                                                        <form id="toggle-status-form6-{{ $agreement->id }}"
                                                            action="{{ route('admin.airline.agreements.statusupdate', $agreement->id) }}#provision"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <label class="switch">
                                                                <input type="checkbox"
                                                                    onchange="updateStatus6({{ $agreement->id }}, this)"
                                                                    {{ $agreement->status == 1 ? 'checked' : '' }}>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </form>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.airline.pli.store') }}#provision" method="POST"
                                            ...
                                            <div class="form-group">
                                                <label for="term">Business Class</label>
                                                <div class="row">
                                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="term">Preimum Class</label>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="term">INTL:</label>
                                            ...
                                            <div class="form-group">
                                                <label for="term">Economy Class</label>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="term">INTL:</label>
