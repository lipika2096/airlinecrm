...
@section('content')
        <!-- Page Wrapper -->
        <div class="page-wrapper" style="overflow: scroll !important;">
            <!-- Page Content -->
            <div class="content container-fluid">
                ...
                <div class="row board-view-header">
                        ...
                        <div class="pro-teams">
                            <div class="pro-team-lead">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-11.jpg')}}">
                                    </div>
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-01.jpg')}}">
                                    </div>
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-16.jpg')}}">
                                    </div>
                                    <div class="avatar">
                            ...
                            <div class="pro-team-members">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}">
                                    </div>
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}">
                                    </div>
                                    <div class="avatar">
                                        <img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{asset('public/assets/img/profiles/avatar-12.jpg')}}">
                                    </div>
                                    <div class="avatar">
                    ...
                    <div class="col-8 text-end">
                        ...
                        <a href="{{route('admin.project-view')}}" class="btn btn-white float-end" title="View Board"><i class="fa fa-link"></i></a>
                    </div>
                                            ...
                                            <div class="task-board-body">
                                                ...
                                                <div class="kanban-footer">
                                                    ...
                                                    <span class="task-users">
                                                        <img src="{{asset('public/assets/img/profiles/avatar-12.jpg')}}" class="task-avatar" width="24" height="24" alt="">
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div>
                                <ul class="chat-user-list">
                                    <li>
                                        <a href="#">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0"><img alt="" src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}"></span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="media d-flex">
                                                <span class="avatar flex-shrink-0"><img alt="" src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}"></span>
                                                <div class="media-body align-self-center text-nowrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="task-follower-list">
                                        <span data-bs-toggle="tooltip" title="John Doe">
                                            <img src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}" class="avatar" alt="John Doe" width="20" height="20">
                                            <i class="fa fa-times"></i>
                                        </span>
                                        <span data-bs-toggle="tooltip" title="Richard Miles">
                                            <img src="{{asset('public/assets/img/profiles/avatar-09.jpg')}}" class="avatar" alt="Richard Miles" width="20" height="20">
                                            <i class="fa fa-times"></i>
                                        </span>
                                        <span data-bs-toggle="tooltip" title="John Smith">
                                            <img src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}" class="avatar" alt="John Smith" width="20" height="20">
                                            <i class="fa fa-times"></i>
                                        </span>
                                        <span data-bs-toggle="tooltip" title="Mike Litorus">
                                            <img src="{{asset('public/assets/img/profiles/avatar-05.jpg')}}" class="avatar" alt="Mike Litorus" width="20" height="20">
                                            <i class="fa fa-times"></i>
                                        </span>
                                    </div>
                                </div>
