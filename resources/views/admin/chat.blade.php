                                    ...
                                    <div class="navbar">
                                        <div class="user-details me-auto">
                                            ...
                                            <div class="user-info float-start">
                                                <a href="{{route('admin.admin-profile')}}" title="Mike Litorus"><span>Mike Litorus</span> <i class="typing-text">Typing...</i></a>
                                                                ...
                                                                <div class="chat-content img-content">
                                                                    <div class="chat-img-group clearfix">
                                                                        ...
                                                                        <a class="chat-img-attach" href="#">
                                                                            <img width="182" height="137" alt="" src="{{asset('public/assets/img/placeholder.jpg')}}">
