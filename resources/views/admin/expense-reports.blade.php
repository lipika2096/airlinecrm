                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>5 Jan 2019</td>
                                    <td>
                                        <a href="{{route('admin.admin-profile')}}" class="avatar avatar-xs">
                                            <img src="{{asset('public/assets/img/profiles/avatar-04.jpg')}}" alt="">
                                        </a>
                                        <h2><a href="{{route('admin.admin-profile')}}">Loren Gatlin</a></h2>
                                    </td>
                                    <td>$ 1215</td>
                                    <td>Cash</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.admin-profile')}}" class="avatar avatar-xs">
                                            <img src="{{asset('public/assets/img/profiles/avatar-03.jpg')}}" alt="">
                                        </a>
                                        <h2><a href="{{route('admin.admin-profile')}}">Tarah Shropshire</a></h2>
                                    </td>
                                    <td>$ 1215</td>
                                    <td>Cheque</td>
                                    <td class="text-center">
