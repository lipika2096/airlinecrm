                                ...
                                <table class="table table-striped table-nowrap custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-11.jpg')}}"></a>
                                                    <a href="#">Wilmer Deluna</a>
                                                </h2>
                                            </td>
                                            <td>wilmerdeluna@example.com</td>
                                            <td>9876543210</td>
                                            <td><a href="{{route('admin.project-view')}}">Hospital Administration</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-01.jpg')}}"></a>
                                                    <a href="#">Lesley Grauer</a>
                                                </h2>
                                            </td>
                                            <td>lesleygrauer@example.com</td>
                                            <td>9876543210</td>
                                            <td><a href="{{route('admin.project-view')}}">Video Calling App</a></td>
                                            <td>
                                                <ul class="team-members">
                                                    <li>
                                                        <a href="#" title="John Doe" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}"></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-16.jpg')}}"></a>
                                                    <a href="#">Jeffery Lalor</a>
                                                </h2>
                                            </td>
                                            <td>jefferylalor@example.com</td>
                                            <td>9876543210</td>
                                            <td><a href="{{route('admin.project-view')}}">Office Management</a></td>
                                            <td>
                                                <ul class="team-members">
                                                    <li>
                                                        <a href="#" title="John Doe" data-bs-toggle="tooltip"><img alt="" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}"></a>
