    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <form method="GET" action="{{ route('admin.confirm.requests.search') }}" class="form-inline search-bar">
                    <div class="search-wrapper">
                        <i class="fa fa-search"></i>
                        <input class="form-control mr-sm-2" type="search" placeholder="Request Id / PNR"
                ...
                <div class="table-responsive">
                    <table class="table table-striped custom-table mb-0 datatable">
                        ...
                        <tbody>
                            @if (!empty($confirmRequest) && $confirmRequest->count() > 0)
                                @foreach ($confirmRequest as $data)
                                    <tr>
                            ...
                            @else
                                <tr>
                                    <td colspan="12">No Data found</td> <!-- Adjust colspan as needed -->
                                </tr>
                            @endif
                        </tbody>
                    </table>
