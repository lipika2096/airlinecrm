                                ...
                                <div class="card-body">
                                        ...
                                        <div class="mailview-header">
                                            ...
                                            <div class="sender-info">
                                                <div class="sender-img">
                                                    <img width="40" alt="" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}" class="rounded-circle">
                                                </div>
                                    ...
                                    <div class="mail-attachments">
                                        ...
                                        <ul class="attachments clearfix">
                                            ...
                                            <li>
                                                <div class="attach-file"><img src="{{asset('public/assets/img/placeholder.jpg')}}" alt="Attachment"></div>
