                                    ...
                                    <div class="navbar">
                                        <div class="user-details me-auto">
                                            <div class="float-start user-img">
                                                <a class="avatar" href="{{route('admin.admin-profile')}}" title="Mike Litorus">
                                                    <img src="{{asset('public/assets/img/profiles/avatar-05.jpg')}}" alt="" class="rounded-circle">
                                                    <span class="status online"></span>
                                                </a>
                                            </div>
                                            <div class="user-info float-start">
                                                <a href="{{route('admin.admin-profile')}}"><span>Mike Litorus</span></a>
                                ...
                                <div class="chat-contents">
                                    <div class="chat-content-wrap">
                                        <div class="voice-call-avatar">
                                            <img src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}" alt="" class="call-avatar">
                                        ...
                                        <div class="call-users">
                                            <ul>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{asset('public/assets/img/profiles/avatar-03.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{asset('public/assets/img/profiles/avatar-08.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{asset('public/assets/img/profiles/avatar-05.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div class="chat chat-left">
                                                        <div class="chat-avatar">
                                                            <a href="{{route('admin.admin-profile')}}" class="avatar">
                                                                <img alt="John Doe" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}">
                                                            </a>
                                                        </div>
                                                        <div class="chat-body">
                                                                            ...
                                                                            <div class="chat-content">
                                                                                ...
                                                                                <ul class="attach-list">
                                                                                    <li class="img-file">
                                                                                        ...
                                                                                        <div class="task-attach-img"><img src="{{asset('public/assets/img/user.jpg')}}" alt=""></div>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="chat-footer">
                                                <div class="message-bar">
                                                    <div class="message-inner">
                                                        <a class="link attach-icon" href="#" data-bs-toggle="modal" data-bs-target="#drag_files"><img src="{{asset('public/assets/img/attachment.png')}}" alt=""></a>
                                                    ...
                                                    <div class="table-content">
                                                        <div class="chat-profile-img">
                                                            <div class="edit-profile-img">
                                                                <img src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}" alt="">
                                ...
                                <div>
                                    ...
                                    <ul class="chat-user-list">
                                        <li>
                                            <a href="#">
                                                <div class="media d-flex">
                                                    <span class="avatar align-self-center flex-shrink-0"><img alt="" src="{{asset('public/assets/img/profiles/avatar-16.jpg')}}"></span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="media d-flex">
                                                    <span class="avatar align-self-center flex-shrink-0"><img alt="" src="{{asset('public/assets/img/profiles/avatar-13.jpg')}}"></span>
                                                    <div class="media-body align-self-center text-nowrap flex-grow-1">
