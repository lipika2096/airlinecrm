                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="#allstaff" data-bs-toggle="tab" class="nav-link active">All
                                    Current Staff</a></li>
                            <li class="nav-item"><a href="#branch" data-bs-toggle="tab" class="nav-link">By Department</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        @foreach ($employees as $index => $data)
                                                ...
                                                <td>
                                                    @if (!empty($data->avatar_filename))
                                                        <img src="{{ asset('staff/storage/avatars/' . $data->avatar_directory . '/' . $data->avatar_filename) }}"
                                                            alt="">
                                                    @else
                                                        <img src="{{ asset('public/assets/img/user.jpg/') }}"
                                                            alt="">
                                                    @endif
                                                </td>
                                            ...
                                            {{-- edit employee --}}
                                            <div id="edit_employee_{{ $data->id }}" class="modal custom-modal fade"
                                                role="dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <!-- <div class="form-group"> -->
                                                                        <label class="form-label">Total Leave <span
                                                                                class="text-danger">*</span></label>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input class="form-control" name="personal_phone"
                                                                            type="text"
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input class="form-control" name="company_mobile"
                                                                            type="text"
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input class="form-control" name="work_type"
                                                                            type="text"
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" name="min_hrs"
                                                                                type="text"
                                                                                value="{{ $data->min_hrs }}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" name="max_hrs"
                                                                                type="text"
                                                                                value="{{ $data->max_hrs }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Date of Resignation
                                                                            </label>
                                                                            <input class="form-control"
                                                                                name="date_of_resignation" type="text"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading{{ \Str::slug($departments) }}">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapse{{ \Str::slug($departments) }}"
                                                aria-expanded="true"
                                                aria-controls="collapse{{ \Str::slug($departments) }}">
                                                <strong style="padding-right:10px;">Department:</strong>
                                                {{ $departments }}
                                            </button>
                                        </h2>
                                        <div id="collapse{{ \Str::slug($departments) }}"
                                            class="accordion-collapse collapse"
                                            aria-labelledby="heading{{ \Str::slug($departments) }}"
                                            data-bs-parent="#discountAccordion" style="padding:10px 20px;">
                                                ...
                                                <table class="table table-striped custom-table mb-0 datatable">
                                                    ...
                                                    <tbody>
                                                        @foreach ($employees as $index => $employee)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if (!empty($employee->avatar_filename))
                                                                        <img src="{{ asset('staff/storage/avatars/' . $employee->avatar_directory . '/' . $employee->avatar_filename) }}"
                                                                            alt="">
                                                                    @else
                                                                        <img src="{{ asset('public/assets/img/user.jpg/') }}"
                                                                            alt="">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="action-icon"
                                                                        href="{{ route('admin.view-staff', ['id' => $employee->id]) }}">
                                                                        <i class="fa fa-eye m-r-5"></i>
                                                                    </a>
                                                                    <a class="action-icon" href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#editemployee_modal{{ $employee->id }}"><i
                                                                            class="fa fa-pencil"></i></a>
                                                                    <a href="#" class="action-icon"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleteemployee_modal_{{ $employee->id }}"
                                                                        style="">
                                                                        <i class="fa fa-trash"></i>
                                                                    </a>
                                                                </td>
                                                            ...
                                                            <div id="editemployee_modal{{ $employee->id }}"
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            name="unique_id"value="{{ $employee->unique_id }}">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <!-- <div class="form-group"> -->
                                                                                        <label class="form-label">Personal
                                                                                            Mobile </label>
                                                                                        <input class="form-control"
                                                                                            name="personal_phone"
                                                                                            type="text"
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        ...
                                                                                        <input class="form-control"
                                                                                            name="company_mobile"
                                                                                            type="text"
                                                                                            value="{{ $employee->company_mobile }}">
                                                                                    </div>
                                                                                    <!-- </div> -->

                                                                                    <div class="col-sm-4">
                                                                                        <!-- <div class="form-group"> -->
                                                                                        <label class="form-label">Work Type
                                                                                        </label>
                                                                                        <input class="form-control"
                                                                                            name="work_type"
                                                                                            type="text"
                                                            ...
                                                            <!-- /Edit Employee Modal -->
                                                            <div id="deleteemployee_modal_{{ $employee->id }}"
                                                                class="modal custom-modal fade" role="dialog">
                                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
