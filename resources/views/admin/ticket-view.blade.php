                            ...
                            <div class="navbar">
                                <div class="float-start ticket-view-details">
                                    <div class="ticket-header">
                                        ...
                                        <span><a href="{{route('admin.admin-profile')}}">John Doe</a></span>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="col-md-3 col-sm-6">
                                                            <div class="uploaded-box">
                                                                <div class="uploaded-img">
                                                                    <img src="{{asset('public/assets/img/placeholder.jpg')}}" class="img-fluid" alt="">
                                                                </div>
                        ...
                        <div class="chat-footer">
                            <div class="message-bar">
                                <div class="message-inner">
                                    <a class="link attach-icon" href="#"><img src="{{asset('public/assets/img/attachment.png')}}" alt=""></a>
                            ...
                            <div class="project-members task-followers">
                                ...
                                <a href="#" data-bs-toggle="tooltip" title="Wilmer Deluna" class="avatar">
                                    <img src="{{asset('public/assets/img/profiles/avatar-11.jpg')}}" alt="">
                                </a>
