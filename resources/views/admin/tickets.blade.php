                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a class="avatar avatar-xs" href="{{route('admin.admin-profile')}}"><img alt="" src="{{asset('public/assets/img/profiles/avatar-10.jpg')}}"></a>
                                            <a href="#">John Smith</a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a class="avatar avatar-xs" href="{{route('admin.admin-profile')}}"><img alt="" src="{{asset('public/assets/img/profiles/avatar-08.jpg')}}"></a>
