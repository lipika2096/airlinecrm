                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-border">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Created by:</td>
                                        <td class="text-end"><a href="{{route('admin.admin-profile')}}">Barry Cuda</a></td>
                                    </tr>
                                    <tr>
                                        <td>Status:</td>
                            ...
                            <ul class="list-box">
                                <li>
                                    <a href="{{route('admin.admin-profile')}}">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-11.jpg')}}"></span>
                                            </div>
                                            <div class="list-body">
                                ...
                                <li>
                                    <a href="{{route('admin.admin-profile')}}">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-01.jpg')}}"></span>
                                            </div>
                                            <div class="list-body">
                            ...
                            <ul class="list-box">
                                <li>
                                    <a href="{{route('admin.admin-profile')}}">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar"><img alt="" src="{{asset('public/assets/img/profiles/avatar-02.jpg')}}"></span>
                                            </div>
                                            <div class="list-body">
