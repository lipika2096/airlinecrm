...
Route::prefix('admin')->name('admin.')->middleware(['auth:admin', 'verified'])->group(function () {
    ...
    Route::post('agent/casehistory/update/{id}', [AgentController::class, 'caseUpdate'])->name('agent.cases.update');
   ...
   Route::get('employees', [EmployeeController::class, 'allEmployees'])->name('employees');
    ...
    Route::patch('admin/agreements/statusupdate/{id}', [AgreementController::class, 'agreemenstStatusUpdate'])->name('airline.agreements.statusupdate');
