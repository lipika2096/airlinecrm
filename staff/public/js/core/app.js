...
function NXSettingsLogo() {
    ...
    //upload logo
    $("#fileupload_single_image").dropzone({
        url: "staff/upload-app-logo?logo_size=" + logo_size,
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        maxFiles: 1,
