<head>
    ...
    @if(auth()->check())
    <link
        href="{{asset('/public/themes/')}}/{{ auth()->user()->pref_theme }}/css/style.css?v={{ config('system.settings_system_javascript_versioning') }}"
        rel="stylesheet">
    @else
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('public/images/favicon/favicon.png')}}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{asset('public/images/favicon/favicon.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('public/images/favicon/favicon.png')}}">
