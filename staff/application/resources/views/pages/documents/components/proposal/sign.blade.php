...
<script src="{{asset('public/vendor/js/signaturepad/signature_pad.min.js?v=')}}{{ config('system.versioning') }}"></script>
<script src="{{asset('/public/js/dynamic/sign.document.js?v=')}}{{ config('system.versioning') }}"></script>