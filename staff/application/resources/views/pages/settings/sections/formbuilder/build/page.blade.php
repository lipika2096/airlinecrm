...
<div id="webform-builder-wraper" class="p-t-40">
    ...
    <script src="http://localhost/GROWCRM/public/vendor/js/formbuilder/form-builder.min.js?v={{ config('system.versioning') }}"></script>
    <script src="http://localhost/GROWCRM/public/js/webforms/webforms.js?v={{ config('system.versioning') }}"></script>
