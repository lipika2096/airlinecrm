                ...
                <div class="content-container text-light">
                    ...
                    <div class="col-md-4" style="text-align: center;">
                            <div class="card bg-white text-dark" style="width:325px!important; height: 21pc;">
                                <h3 class="mt-3 text-dark">Hello, {{auth()->user()->first_name}} {{auth()->user()->last_name}}</h3>

                                <div class="text-danger">
                                   <b> {{ now()->format('l, F j, Y') }} </b>
                                </div>
                        ...
                        <div class="col-md-4" style="text-align: center;">
                            <div class="card bg-white text-dark " style="width:325px!important; height: 21pc;">
                                ...
                                <svg class="progress-circle-svg" viewBox="0 0 100 100">
                                        ...
                                        <text x="50" y="52" text-anchor="middle" alignment-baseline="middle" class="progress-text">{{ $payload['remainingLeave'] ?? 'N/A' }}</text>
                                    </svg>
                                ...
                                <p class="mt-5">You still have {{ $payload['remainingLeave'] ?? 'N/A' }} vacation days left from this year.</p>
                        ...
                        <div class="col-md-4" style="text-align: center;">
                            <div class="card bg-white text-dark " style="width:325px!important; height: 21pc;">
                                ...
                                <ul class="list-unstyled" style="margin-top: 2rem !important;">
                                    @forelse ($payload['absent_colleagues'] as $leave)
                                        <li>{{ optional($leave->employee)->first_name }} {{ optional($leave->employee)->last_name }}({{ $leave->leave_type }})</li>
                                    @empty
                                    ...
                                    <div class="row">
                                        <div class="col-md-4" style="text-align: -webkit-right;">
                                            <p class="bg-info stv ms-4 mt-4" style="    text-align: center;"><span
                                                    class="mt-5 text-white dtxt fw-bold">{{ $payload['noofpresentemployeestoday']}} / {{ $payload['total_employee']}}</span></p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4" style="text-align: -webkit-right;">
                                            <p class="bg-warning stv ms-4 mt-4" style="    text-align: center;"><span
                                                    class="mt-5 text-white dtxt fw-bold">{{ $payload['total_leaves'] ?? 'N/A' }}</span></p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4" style="text-align: -webkit-right;">
                                            <p class="bg-primary stv ms-4 mt-4" style="    text-align: center;"><span
                                                    class="mt-5 text-white dtxt fw-bold">{{ $payload['total_pending_leaves'] ?? 'N/A' }}</span></p>
                                        </div>
