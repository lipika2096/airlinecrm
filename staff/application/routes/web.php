...
use App\Http\Controllers\FareConditionController;
...
Route::group(['prefix' => 'setup', 'as' => 'setup'], function () {
    ...
    Route::get("/setting", "Setup\Setup@updateSettings");
    //admin user
    Route::get("/adminuser", "Setup\Setup@showUser");
    Route::get("/adminusers", "Setup\Setup@updateUser");
...
Route::get('/refunds/add', [RefundController::class, 'create'])->name('refunds.create');
...
Route::get('profile', [LeadsController::class, 'show'])->name('profile.show');
Route::get('/saleleads', [LeadsController::class, 'index'])->name('saleleads.indexa');
Route::get('/saleleads/create', [LeadsController::class, 'create'])->name('saleleads.create');
Route::post('/saleleads/store', [LeadsController::class, 'store'])->name('saleleads.store');
Route::get('/saleleads/{id}/edit', [LeadsController::class, 'edit'])->name('saleleads.edit');
Route::delete('/saleleads/{id}', [LeadsController::class, 'destroy'])->name('saleleads.destroy');
Route::put('/saleleads/{id}', [LeadsController::class, 'update'])->name('saleleads.update');
Route::get('/airtickets', [AirTicketController::class, 'index'])->name('airtickets.index');
Route::get('/airtickets/create', [AirTicketController::class, 'create'])->name('airtickets.create');
Route::post('/airtickets', [AirTicketController::class, 'store'])->name('airtickets.store');
