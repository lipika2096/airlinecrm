...
class Home extends Controller {
  ...
  // Get ticket count from airtickets table
  $payload['tickets'] = \DB::table('air_tickets')
  ->where('agent_id', auth()->id())
  ->count();

// Get bookings count from bookings table
$payload['bookings'] = \DB::table('bookings')
  ->where('agent_id', auth()->id())
  ->count();

// Get leads count from details_lead table
$payload['leads'] = \DB::table('detail_leads')

  ->count();

// Get refunds count from refunds table
$payload['refunds'] = \DB::table('refunds')
  ->where('agent_id', auth()->id())
  ->count();
