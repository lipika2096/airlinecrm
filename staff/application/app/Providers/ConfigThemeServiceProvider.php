...
class ConfigThemeServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        if (env('SETUP_STATUS') != 'COMPLETED') {
            //set default theme
            config([
                'theme.selected_theme_css' => asset('/public/themes/default/css/style.css?v=1'),
            ]);
            //skip this provider
            return;
        }
        ...
        config([
            ...
            //main css file
            'theme.selected_theme_css' => asset('public/themes/') .'/'. $settings->settings_theme_name . '/css/style.css?v=' . $settings->settings_system_javascript_versioning,
            ...
            'theme.selected_theme_pdf_css' => asset('public/themes/default/css/bill-pdf.css?v=') . $settings->settings_system_javascript_versioning,
        ]);
