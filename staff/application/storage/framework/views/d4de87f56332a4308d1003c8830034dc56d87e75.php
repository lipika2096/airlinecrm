...
<tr id="ticket_<?php echo e($ticket->ticket_id); ?>">
    ...
    <td class="tickets_col_id"><a href="<?php echo e(url('/tickets/'.$ticket->ticket_id )); ?>"><?php echo e($ticket->ticket_id); ?></a></td>
    <?php endif; ?>
    <td class="tickets_col_subject">
        <a href="<?php echo e(url('tickets/'.$ticket->ticket_id )); ?>"><?php echo e(str_limit($ticket->ticket_subject ?? '---', 35)); ?></a>
    </td>
...
<!--each row--><?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/pages/tickets/components/table/ajax.blade.php ENDPATH**/ ?>