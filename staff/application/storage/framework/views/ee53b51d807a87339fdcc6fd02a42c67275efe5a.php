...
<body id="main-body"
    ...
    <div class="backgroundheadingsection">
        ...
        <div class="col-md-12" style="text-align: right;">
            <a href="<?php echo e(route('bank.create')); ?>" class="btn btn-primary mb-3">Request Wallet</a>
        </div>
        <table class="table table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $walletRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($data->id); ?></td>
                        <td><?php echo e($data->payment_mode); ?></td>
                        <td><?php echo e($data->bank_tran_id); ?></td>
                        ...
                        <td><a href="<?php echo e(route('bank.show',['id'=> $data->id])); ?>"
...
<?php /**PATH C:\xampp\htdocs\hrcrm\staff\application\resources\views/wallet-request/index.blade.php ENDPATH**/ ?>