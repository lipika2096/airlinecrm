...
<body id="main-body"
    ...
    <div class="col-md-6" style="text-align: right;">
        <a href="<?php echo e(route('refunds.create')); ?>" class="btn btn-primary mb-3">Create +</a>
        </div>
 </div>
                    ...
                    <?php $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="width:130px;">
                                <a href="<?php echo e(route('refunds.edit', $refund->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                <form action="<?php echo e(route('refunds.destroy', $refund->id)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this refund?')">Delete</button>
                                </form>
                            </td>
                        </tr>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/refunds/index.blade.php ENDPATH**/ ?>