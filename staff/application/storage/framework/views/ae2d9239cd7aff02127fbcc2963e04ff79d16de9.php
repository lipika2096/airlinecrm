...
<body id="main-body"
    ...
    <div class="col-md-6" style="text-align: right;">
       ...
       <form action="<?php echo e(route('leads.storea')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/leads/create.blade.php ENDPATH**/ ?>