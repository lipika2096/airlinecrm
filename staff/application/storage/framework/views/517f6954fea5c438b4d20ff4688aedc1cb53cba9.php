                        ...
                        <div class="card-body">
                            <div class="time-list">
                                <div class="dash-stats-list">
                                    <h4><?php echo e($payload['tickets']); ?></h4>
                ...
                <section>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="time-list">
                                <div class="dash-stats-list">
                                    <h4><?php echo e($payload['refunds']); ?></h4>
                                    <p>Total Refunds</p>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/pages/home/client/widgets/first-row/wrapper.blade.php ENDPATH**/ ?>