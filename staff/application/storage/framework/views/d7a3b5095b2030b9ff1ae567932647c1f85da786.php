...
<!--javascript-->
<script src="http://localhost/GROWCRM/public/js/core/messages.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grow\application\resources\views/pages/messages/wrapper.blade.php ENDPATH**/ ?>