...
<div class="login-logo m-t-30 p-b-5">
    <a href="javascript:void(0)" class="text-center db">
        <img src="<?php echo e(asset('storage/logos/app/logo2.png')); ?>" alt="Home">
    </a>
</div>
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/pages/authentication/login.blade.php ENDPATH**/ ?>