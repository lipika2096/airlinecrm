        ...
        <tbody>
            <?php $__currentLoopData = $airTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php switch($airTicket->status):
                    case ('approved'): ?>
                        <span class="badge badge-success"><?php echo e(ucfirst($airTicket->status)); ?></span>
                        <?php break; ?>
                    <?php case ('canceled'): ?>
                        <span class="badge badge-warning"><?php echo e(ucfirst($airTicket->status)); ?></span>
                        <?php break; ?>
                    <?php case ('rejected'): ?>
                        <span class="badge badge-danger"><?php echo e(ucfirst($airTicket->status)); ?></span>
                        <?php break; ?>
                    <?php default: ?>
            ...
            <td>
                <form action="<?php echo e(route('airtickets.update_status', $airTicket->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <select name="status" class="form-control" required>
                        <option value="approved" <?php echo e($airTicket->status == 'approved' ? 'selected' : ''); ?>>Approved</option>
                        <option value="canceled" <?php echo e($airTicket->status == 'canceled' ? 'selected' : ''); ?>>Canceled</option>
                        <option value="rejected" <?php echo e($airTicket->status == 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                    </select>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/airtickets/index.blade.php ENDPATH**/ ?>