...
<aside class="left-sidebar" id="js-trigger-nav-team"> <!--[fix] keep id as "js-trigger-nav-team"-->
        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <li data-modular-id="main_menu_client_proposals"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="<?php echo e(url('proposals')); ?>" aria-expanded="false"
                        target="_self">
                ...
                <li data-modular-id="main_menu_client_contracts"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="<?php echo e(url('contracts')); ?>" aria-expanded="false"
                        target="_self">
                        <i class="ti-write"></i>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH C:\xampp\htdocs\grow\application\resources\views/nav/leftmenu-client.blade.php ENDPATH**/ ?>