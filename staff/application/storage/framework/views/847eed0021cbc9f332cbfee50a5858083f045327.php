            ...
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <li data-modular-id="main_menu_client_projects"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(route('profile.show')); ?>" aria-expanded="false"
                        target="_self">
                        <i class="ti-user"></i>
                        <span class="hide-menu">View Profile
                        </span>
                    </a>
                </li>
                <?php endif; ?>
...
<?php if(config('visibility.modules.projects') && auth()->user()->is_client_owner): ?>
                <li data-modular-id="main_menu_client_projects"
                    class="sidenav-menu-item <?php echo e($page['mainmenu_projects'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    title=">Book Tickets">
                    <a class="waves-effect waves-dark" href="<?php echo e(route('airtickets.index')); ?>" aria-expanded="false"
                        target="_self">
                        <i class="ti-wallet"></i>
                        <span class="hide-menu">Book Tickets
                        </span>
                    </a>
                </li>
                <?php endif; ?>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_invoices'] ?? ''); ?>" id="submenu_invoices">
                            <a href="<?php echo e(url('invoices')); ?>"
                                class=" <?php echo e($page['submenu_invoices'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.book_tickets'))); ?></a>
                        </li>
                        <?php endif; ?> -->
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_payments'] ?? ''); ?>" id="submenu_payments">
                            <a href="<?php echo e(route('bookings.index')); ?>"
                                class=" <?php echo e($page['submenu_payments'] ?? ''); ?>">Manage Bookings</a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_estimates'] ?? ''); ?>" id="submenu_estimates">
                            <a href="<?php echo e(route('bookings.cancel')); ?>"
                                class=" <?php echo e($page['submenu_estimates'] ?? ''); ?>">Cancel Bookings</a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_subscriptions'] ?? ''); ?>" id="submenu_subscriptions">
                            <a href="<?php echo e(route('bookings.history')); ?>"
                                class=" <?php echo e($page['submenu_subscriptions'] ?? ''); ?>">Booking history</a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
  ...
  <?php if(config('visibility.modules.proposals') && auth()->user()->is_client_owner): ?>
                <li data-modular-id="main_menu_client_billing"
                    ...
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
                        <i class="ti-wallet"></i>
                        <span class="hide-menu">Fare Conditions
                        </span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <?php if(config('visibility.modules.invoices')): ?>
                        <li class="sidenav-submenu <?php echo e($page['submenu_invoices'] ?? ''); ?>" id="submenu_invoices">
                            <a href="<?php echo e(route('fare_conditions.index')); ?>"
                                class=" <?php echo e($page['submenu_invoices'] ?? ''); ?>">Fare Conditions</a>
                        </li>
                        <li class="sidenav-submenu <?php echo e($page['submenu_invoices'] ?? ''); ?>" id="submenu_invoices">
                            <a href="<?php echo e(route('commissions.index')); ?>"
                                class=" <?php echo e($page['submenu_invoices'] ?? ''); ?>">Commission</a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/nav/leftmenu-client.blade.php ENDPATH**/ ?>