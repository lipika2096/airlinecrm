...
<div class="row" id="js-trigger-clients-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <div id="add_client_billing_address_section" class="hidden">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.emergency_number'))); ?></label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.owner_name'))); ?></label>
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="client_custom_field_4" name="client_custom_field_4"
                        value="<?php echo e($client->client_custom_field_4 ?? ''); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.pan_card'))); ?></label>
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="client_custom_field_3" name="client_custom_field_3"
                        value="<?php echo e($client->client_custom_field_3 ?? ''); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.gst'))); ?></label>
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="client_custom_field_2" name="client_custom_field_2"
                        value="<?php echo e($client->client_custom_field_2 ?? ''); ?>">
                </div>
            </div>
            <div class="line"></div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\hrcrm\staff\application\resources\views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>