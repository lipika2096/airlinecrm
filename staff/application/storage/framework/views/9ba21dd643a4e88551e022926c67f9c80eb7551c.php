                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="text-align: right;">
                                        <a href="<?php echo e(route('leave.create')); ?>" class="btn btn-primary mb-3">Add Leave</a>
                                    </div>
                                </div>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="#" class="avatar avatar-xs"><img
                                                                            src="<?php echo e(asset('public/assets/img/profiles/avatar-09.jpg')); ?>"
                                                                            alt=""></a>
                                                                    <a href="#"><?php echo e($leave->approved_by); ?></a>
                                                                </h2>
                                                            </td>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/leaves/index.blade.php ENDPATH**/ ?>