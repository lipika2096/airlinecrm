...
<div class="p-t-40 p-b-40" id="updates-container">
    ...
    <div class="updates-card alert alert-warning hidden m-b-30" id="updates-error-message">
        ...
        <div class="m-t-8" id="update-message-url hidden">
            <a href="" id="update-message-url-link" target="_blank"><span class="font-weight-500" id="update-message-url-anchor"></span></a>
        </div>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/pages/settings/sections/updates/page.blade.php ENDPATH**/ ?>