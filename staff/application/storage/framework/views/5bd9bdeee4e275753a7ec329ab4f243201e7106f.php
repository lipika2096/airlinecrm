                ...
                <div class="card-body">
                    <form action="<?php echo e(route('refunds.update', $refund->id)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="booking_id" name="booking_id" required>
                                ...
                                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($booking->id); ?>" <?php echo e($booking->id == $refund->booking_id ? 'selected' : ''); ?>><?php echo e($booking->booking_number); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="passenger_id" name="passenger_id" required>
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>" <?php echo e($user->id == $refund->passenger_id ? 'selected' : ''); ?>><?php echo e($user->unique_id); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="refund_amount" name="refund_amount" value="<?php echo e($refund->refund_amount); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="request_date" name="request_date" value="<?php echo e($refund->request_date); ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="processed_date">Processed Date</label>
                            <input type="date" class="form-control" id="processed_date" name="processed_date" value="<?php echo e($refund->processed_date); ?>">
                        </div>

                        <div class="form-group">
                            <label for="reason">Reason</label>
                            <textarea class="form-control" id="reason" name="reason"><?php echo e($refund->reason); ?></textarea>
                        </div>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/refunds/edit.blade.php ENDPATH**/ ?>