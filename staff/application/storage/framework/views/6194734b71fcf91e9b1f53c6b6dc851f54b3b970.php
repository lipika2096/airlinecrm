    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header" id="topnav-logo-container" >
            ...
            <div class="sidenav-menu-item exit-panel m-b-17">
                <a class="waves-effect waves-dark text-info" href="<?php echo e(url('/')); ?>" id="settings-exit-button"
                    aria-expanded="false" target="_self">
                    <i class="sl-icon-logout text-info"></i>
                    <span id="settings-exit-text" class="font-22"><?php echo e(str_limit(__('lang.exit_settings'), 20)); ?></span>
                </a>
            </div>
            <?php else: ?>
            <!--logo-->
        ...
        <div class="navbar-collapse header-overlay ">
...
</header><?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>