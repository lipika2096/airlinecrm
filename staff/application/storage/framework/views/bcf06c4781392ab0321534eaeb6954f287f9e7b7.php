    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-md-6" style="text-align: right;">
                <a href="<?php echo e(route('saleleads.create')); ?>" class="btn btn-primary mb-3">Create +</a>
            </div>
    </div>
                    ...
                    <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="width: 130px;">
                                <a href="<?php echo e(route('saleleads.edit', $lead->id)); ?>" class="btn btn-sm btn-primary" >Edit</a>
                                <form action="<?php echo e(route('saleleads.destroy', $lead->id)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/salelead/index.blade.php ENDPATH**/ ?>