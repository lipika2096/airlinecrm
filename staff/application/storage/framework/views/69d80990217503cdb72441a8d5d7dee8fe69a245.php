...
<body id="main-body"
    ...
    <div class="col-md-6" style="text-align: right;">
        ...
        <!-- <a href="<?php echo e(route('commissions.create')); ?>" class="btn btn-primary">Create New Commission</a> -->
    <table class="table">
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($commission->airline->airline_code); ?></td>
                    <td><?php echo e($commission->commissions_rate); ?></td>

                    <!-- <td>
                        <a href="<?php echo e(route('commissions.edit', $commission->id)); ?>" class="btn btn-primary">Edit</a>
                        <form action="<?php echo e(route('commissions.destroy', $commission->id)); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/staff/application/resources/views/commissions/index.blade.php ENDPATH**/ ?>