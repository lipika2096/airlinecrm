<head>
    ...
    <!--[if lt IE 9]>
    <script src="http://localhost/GROWCRM/public/vendor/js/html5shiv/html5shiv.js"></script>
    <script src="http://localhost/GROWCRM/public/vendor/js/respond/respond.min.js"></script>
    <![endif]-->
    ...
    <?php if(auth()->check()): ?>
    <link
        href="<?php echo e(asset('/public/themes/')); ?>/<?php echo e(auth()->user()->pref_theme); ?>/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php else: ?>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('public/images/favicon/favicon.png')); ?>">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo e(asset('public/images/favicon/favicon.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('public/images/favicon/favicon.png')); ?>">
...
</head><?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/layout/header.blade.php ENDPATH**/ ?>