...
<body id="main-body"
    ...
    <div class="col-md-6" style="text-align: right;">
        <a href="<?php echo e(route('leads.createa')); ?>" class="btn btn-primary mb-3">Create +</a>
        </div>
 </div>
...
<?php /**PATH /home/pentasof/hrcrm.testpentas.in/agent/application/resources/views/leads/index.blade.php ENDPATH**/ ?>